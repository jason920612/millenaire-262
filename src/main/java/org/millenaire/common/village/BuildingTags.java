...
public class BuildingTags {
   ...
   @DocumentedElement.Documentation("Makes the building into a valid location for gathering snails.")
   ...
   @DocumentedElement.Documentation("Enables the border post type sign.")
   public static final String TAG_BORDERPOSTSIGN = "borderpostsign";
   @DocumentedElement.Documentation("Stops this upgrade until all wall segments have been built.")
   public static final String TAG_NO_UPGRADE_TILL_WALL_INITIALIZED = "no_upgrade_till_wall_initialized";
   @DocumentedElement.Documentation("Wall level, for use in the wall panel. Use with a level added like this: wall_level_0, wall_level_1...")
