...
@DocumentedElement.Documentation("Makes the villager 'rest' at home. Has a priority of 0 and is there to ensure there is always something to do.")
public class GoalGoRest extends Goal {
   ...
   public boolean isPossibleSpecific(MillVillager villager) {
      return villager.getHouse().getPos().distanceTo(villager) > 5.0;
   }
