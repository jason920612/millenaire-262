...
public abstract class GoalGeneric extends Goal implements ParametersManager.DefaultValueOverloaded {
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "Tag a building must have for action to be possible. If absent, then the villager's house is used."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "Extra tag required for the destination to be valid."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "If true, this goal happens in the central building."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "The goal's priority. The higher it is the more likely villagers will pick it."
   )
   public int priority;
   @ConfigAnnotations.ConfigField(
      type = AnnotedParameter.ParameterType.INTEGER,
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "A random value between 0 and this to add to the goal's priority."
   )
   public int priorityRandom;
   @ConfigAnnotations.ConfigField(
      type = AnnotedParameter.ParameterType.MILLISECONDS,
      defaultValue = "5000"
   )
   @ConfigAnnotations.FieldDocumentation(
      explanation = "Duration in ms of the action."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "Specify if the sentences for this goal is not the name of the goal itself."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "Specify if the label for this goal is not the name of the goal itself."
   )
   public String labelKey = null;
   @ConfigAnnotations.ConfigField(
      type = AnnotedParameter.ParameterType.ITEMSTACK_ARRAY
   )
   @ConfigAnnotations.FieldDocumentation(
      explanation = "Items held by the villager, including when traveling."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "Items held by the villager in his off hand, including when traveling."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "Items held by the villager, at destination only."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "Items held by the villager in his off hand, at destination only."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "Sound to play when the goal is performed (metal, wool...)."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "If true, the villager can move 'randomly' after reaching the destination."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "Duration in ms before the action can reoccur."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "If true, the villager will hold his best weapon while doing this goal."
   )
   ...
   @ConfigAnnotations.FieldDocumentation(
      explanation = "Range from destination from which the goal is doable."
   )
   public int range;
   File file = null;
   ...
   public final boolean isPossibleSpecific(MillVillager villager) throws Exception {
      if (this.reoccurDelay > 0
         ...
         && villager.lastGoalTime.get(this) + this.reoccurDelay > villager.level().getOverworldClockTime()) {
         return false;
   ...
   public int priority(MillVillager villager) throws Exception {
      return this.priority + villager.getRandom().nextInt(this.priorityRandom);
   }
