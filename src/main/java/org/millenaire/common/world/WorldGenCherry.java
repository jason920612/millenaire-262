 ...
 * Mirrors the 1.12 algorithm: a spruce trunk, a rounded cherry-leaf canopy and a few branches.
 */
public class WorldGenCherry extends MillTreeGenerator {
   private static final int MIN_TREE_HEIGHT = 6;
   private static final BlockState WOOD_BS = Blocks.SPRUCE_LOG.defaultBlockState();
   private static final BlockState LEAVES_BS = MillBlocks.CHERRY_LEAVES.defaultBlockState()
